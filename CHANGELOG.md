...
- Added the canonical public contract for `BrowseIntent` values `High`, `Medium`, `Low`, and `Expired`.
- Defined missing and unset as unknown rather than an intent state.
